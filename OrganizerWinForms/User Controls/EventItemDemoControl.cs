...
namespace Organizer_Project.UserControls
{
    public partial class EventItemDemoControl : UserControl, Interfaces.IOrganizerItemDemoControl
    {
        ...
        {
            ItemSource.EndEdit();
            return ItemSource.Current as Models.EventItem;
        }
        private void ConfigureDateTimePickers(object sender, ConvertEventArgs cevent)
        {
            bool isCheched = (ItemSource.Current as Models.EventItem).IsAllDay;
        ...
        private void DetailsButton_Click(object sender, System.EventArgs e) => ItemDetailsRequested?.Invoke(this, System.EventArgs.Empty);
    }
}
